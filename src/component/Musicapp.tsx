...
const MusicApp = () => {
  ...
  return (
    <div className="p-4 bg-gradient-to-b from-purple-500 to-purple-700 min-h-screen text-white">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-4 items-center">
          <input
            ...
            className="p-2 text-purple-700 rounded-xl"
          />
      ...
      {isModalVisible && currentSongIndex !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 backdrop-blur-md">
          <div className="bg-gradient-to-b from-purple-500 to-purple-700 text-white p-4 rounded-lg w-3/4 max-w-lg relative">
            <div className="flex flex-col items-center mb-4">
              ...
              <div className="flex justify-center mt-4">
                <button onClick={prevSong} className="mx-2 p-2 bg-black text-white rounded">⏮️</button>
                <button onClick={nextSong} className="mx-2 p-2 bg-black text-white rounded">⏭️</button>
                <button onClick={shuffleSongs} className="mx-2 p-2 bg-black text-white rounded">🔀</button>
                <button onClick={replaySong} className="mx-2 p-2 bg-black text-white rounded">🔄</button>
                <button onClick={stopSong} className="mx-2 p-2 bg-black text-white rounded">⏹</button>
              </div>
            </div>
            <button
